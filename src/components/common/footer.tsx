...
export default function Footer() {
  return (
    <footer className="w-full bg-[#FAFAFA]  border-t border-[#F2F0E8] pt-12 md:pt-20 pb-8 px-4 sm:px-6 md:px-12 lg:px-24 text-[#6B5E50]">
        ...
        <div className="flex flex-col lg:flex-row justify-between mb-16 md:mb-24 gap-12">
          ...
          <div className="max-w-md">
            <div className="flex items-end gap-3 mb-6">
              ...
              />
              <span className="text-xl font-light tracking-wide text-[#6B5C48]">
                Furnishing
              </span>
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-12 sm:gap-16 md:gap-48 mr-0 lg:mr-4 xl:mr-20">
            <div>
              <h2 className="text-[11px] font-semibold uppercase tracking-widest text-[#7A6B58] mb-6">
                Company
              </h2>
              <ul className="space-y-4 text-[13px] font-light">
                <li>
                  <Link
                    href={ROUTES.ABOUT}
                    className="hover:text-[#5A4B38] hover:font-bold hover:underline transition-all duration-300">
                    About
                  </Link>
                </li>
                <li>
