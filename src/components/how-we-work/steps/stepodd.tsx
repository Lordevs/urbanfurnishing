...
const StepOdd = ({
  ...
  return (
    <section className="w-full mx-auto px-4 sm:px-10 lg:px-16 my-12 md:my-20">
      <div className="w-full py-12 md:py-20 px-6 sm:px-12 lg:px-20 mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
        ...
        <motion.div
          ...
          className="relative pl-6 pt-6 pr-6 pb-6 w-full mx-auto lg:max-w-none">
          ...
          <div className="flex flex-col space-y-3 pt-2">
            {features.map((feature, index) => (
              <motion.div
                ...
                className="w-full bg-[#F7F3ED] py-7 px-6 max-w-[700px] flex items-center gap-4 border border-[#f4f1eb]">
                {/* Check Circle */}
                <div className="w-6 h-6 rounded-full border border-[#5D4E3C] flex items-center justify-center shrink-0 bg-[#f4ebd9]/20">
                  <Check
                    className="w-3.5 h-3.5 text-[#5D4E3C]"
                    strokeWidth={2.5}
                  />
                </div>
                <span className="text-[15px] md:text-[16px] text-[#5D4E3C] font-light">
                  {feature}
                </span>
              </motion.div>
            ))}
