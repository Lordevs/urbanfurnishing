    ...
    >
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 w-full">
          ...
          <div className="flex-1 border border-[#EBEBEB] rounded-[16px] p-6 lg:p-8 bg-white shadow-[0_2px_10px_rgba(0,0,0,0.01)]">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[13px] font-medium text-[#1A1A1A]">Phone Number</label>
                <Input 
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[13px] font-medium text-[#1A1A1A]">Street Address</label>
                <Input 
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[13px] font-medium text-[#1A1A1A]">Apartment, suite, etc. (optional)</label>
                <Input 
                  placeholder="Apt 4B" 
                  className="h-[46px] bg-[#F5F5F5] border-none rounded-[8px] px-3.5 text-[14px] text-[#1A1A1A] placeholder:text-[#888888]/80 focus-visible:ring-1 focus-visible:ring-[#C9A76A]" 
                />
              ...
              <div className="flex flex-col sm:flex-row gap-5">
                <div className="flex-1 flex flex-col gap-1.5">
                  <label className="text-[13px] font-medium text-[#1A1A1A]">City</label>
                  <Input 
                    placeholder="Mumbai" 
                    className="h-[46px] bg-[#F5F5F5] border-none rounded-[8px] px-3.5 text-[14px] text-[#1A1A1A] placeholder:text-[#888888]/80 focus-visible:ring-1 focus-visible:ring-[#C9A76A]" 
                  />
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[13px] font-medium text-[#1A1A1A]">Postal Code</label>
                <Input 
                  placeholder="400001" 
                  className="h-[46px] bg-[#F5F5F5] border-none rounded-[8px] px-3.5 text-[14px] text-[#1A1A1A] placeholder:text-[#888888]/80 focus-visible:ring-1 focus-visible:ring-[#C9A76A]" 
                />
            ...
            <div className="flex flex-col gap-5">
              ...
              <label className="flex items-center gap-3 mb-1 cursor-pointer w-max">
                <div className="relative flex items-center justify-center">
                  <input type="checkbox" className="peer w-[18px] h-[18px] appearance-none border border-[#D9D9D9] rounded-[4px] bg-[#F5F5F5] checked:bg-[#412A1F] checked:border-[#412A1F] transition-colors cursor-pointer" />
                ...
                <span className="text-[13.5px] font-medium text-[#1A1A1A]">Same as shipping address</span>
              </label>
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[13px] font-medium text-[#1A1A1A]">Company (optional)</label>
                <Input 
      ...
      <div className="lg:hidden flex flex-col gap-6 -mt-4">
        <h2 className="text-[20px] font-bold text-[#1a1a1a] flex items-center gap-2">
          Shipping <span className="text-[14px] font-normal text-[#888888]">⇋</span> Billing Address
        </h2>
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-2">
            <label className="text-[13px] text-[#888888] font-medium">Email Address</label>
            <Input 
              placeholder="john.doe@example.com" 
              className="h-[52px] bg-[#F9FAFB] border-none rounded-[12px] px-4 text-[15px] focus-visible:ring-1 focus-visible:ring-[#C9A76A]" 
            />
          ...
          <div className="flex flex-col gap-2">
            <label className="text-[13px] text-[#888888] font-medium">Phone Number</label>
            <Input 
          ...
          <div className="flex flex-col gap-2">
            <label className="text-[13px] text-[#888888] font-medium">Country</label>
            <div className="relative">
              <select defaultValue="" className="w-full h-[52px] bg-[#F9FAFB] border-none rounded-[12px] px-4 text-[15px] text-[#1a1a1a] appearance-none outline-none focus-visible:ring-1 focus-visible:ring-[#C9A76A] cursor-pointer">
          ...
          <div className="flex flex-col gap-2">
            <label className="text-[13px] text-[#888888] font-medium">Special Instructions</label>
            <textarea 
