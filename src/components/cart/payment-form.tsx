...
export function PaymentForm({
  ...
  const handleSubmit = () => {
    ...
    const payload: Omit<OrderPayload, "payment_method"> & { payment_method: "CARD" | "UPI" } = {
        ...
        <div className="flex-1 w-full flex flex-col gap-6">
          ...
          <div className="border border-[#EBEBEB] rounded-[16px] p-6 lg:p-8 bg-white shadow-[0_2px_10px_rgba(0,0,0,0.01)]">
            ...
            <div className="flex flex-col gap-5">
              {/* Credit/Debit Card */}
              <label
                className={`flex items-center justify-between p-5 rounded-[12px] border cursor-pointer transition-all ${paymentMethod === "card" ? "border-[#EBEBEB]" : "border-[#F2F2F2] hover:border-[#EBEBEB]"}`}
              >
                <div className="flex items-center gap-4">
                  ...
                  <CreditCard
                    className="w-[20px] h-[20px] text-[#555555]"
                    strokeWidth={1.5}
                  />
                ...
                <div className="flex gap-2">
                  <span className="text-[12px] font-medium text-[#1A1A1A] bg-white border border-[#EBEBEB] px-2.5 py-1 rounded-[6px]">
                    Visa
                  </span>
                  <span className="text-[12px] font-medium text-[#1A1A1A] bg-white border border-[#EBEBEB] px-2.5 py-1 rounded-[6px]">
                    Mastercard
              ...
              {/* UPI Payment */}
              <label
                className={`flex items-center justify-between p-5 rounded-[12px] border cursor-pointer transition-all ${paymentMethod === "upi" ? "border-[#EBEBEB]" : "border-[#F2F2F2] hover:border-[#EBEBEB]"}`}
              >
                <div className="flex items-center gap-4">
                  <div className="relative flex items-center justify-center">
                    <input
              ...
              {/* Digital Wallet */}
              <label
                className={`flex items-center justify-between p-5 rounded-[12px] border cursor-pointer transition-all ${paymentMethod === "wallet" ? "border-[#EBEBEB]" : "border-[#F2F2F2] hover:border-[#EBEBEB]"}`}
              >
                <div className="flex items-center gap-4">
                  <div className="relative flex items-center justify-center">
                    <input
          ...
          <div className="bg-white border border-[#EBEBEB] rounded-[16px] p-6 lg:p-7 shadow-[0_2px_10px_rgba(0,0,0,0.02)] w-full">
            ...
            <div className="flex flex-col gap-3">
              ...
              <Button
                ...
                disabled={isPending}
                className="w-full h-[52px] bg-[#412A1F] hover:bg-[#2C1A11] disabled:bg-[#412A1F]/50 disabled:cursor-not-allowed text-white rounded-[10px] text-[14.5px] font-medium flex items-center justify-between px-6 transition-all shadow-md cursor-pointer hover:shadow-lg hover:-translate-y-0.5"
              >
                {isPending ? (
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center gap-5 mt-4 pt-6 border-t border-[#F2F2F2]/60 pb-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
          ...
          <Button
            onClick={handleSubmit}
            disabled={isPending}
            className="w-full sm:w-auto h-[48px] bg-[#412A1F] hover:bg-[#2C1A11] disabled:bg-[#412A1F]/50 text-white rounded-[24px] text-[14.5px] font-medium flex items-center justify-between sm:justify-center gap-4 px-2.5 sm:pl-6 sm:pr-2.5 pl-6 transition-all shadow-md cursor-pointer hover:shadow-lg"
          >
            {isPending ? (
