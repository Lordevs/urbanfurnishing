    ...
    >
          ...
          <div className="flex-1 w-full flex flex-col gap-6">
            ...
            <div className="border border-[#EBEBEB] rounded-[16px] p-6 lg:p-8 bg-white shadow-[0_2px_10px_rgba(0,0,0,0.01)]">
              ...
              <div className="flex flex-col gap-5">
                {/* Credit/Debit Card */}
                <label className={`flex items-center justify-between p-5 rounded-[12px] border cursor-pointer transition-all ${paymentMethod === 'card' ? 'border-[#C9A76A] bg-[#C9A76A]/5' : 'border-[#F2F2F2] hover:border-[#EBEBEB]'}`}>
                  <div className="flex items-center gap-4">
                    ...
                    <CreditCard className="w-[20px] h-[20px] text-[#412A1F]" strokeWidth={1.5} />
                    <span className="text-[14.5px] font-medium text-[#1A1A1A]">Credit/Debit Card</span>
                  </div>
                  <div className="flex gap-2">
                    <span className="text-[11px] font-bold text-[#412A1F] bg-[#412A1F]/5 px-2 py-0.5 rounded uppercase">Visa</span>
                    <span className="text-[11px] font-bold text-[#412A1F] bg-[#412A1F]/5 px-2 py-0.5 rounded uppercase">Mastercard</span>
                  </div>
                </label>

                <label className={`flex items-center justify-between p-5 rounded-[12px] border cursor-pointer transition-all ${paymentMethod === 'cod' ? 'border-[#C9A76A] bg-[#C9A76A]/5' : 'border-[#F2F2F2] hover:border-[#EBEBEB]'}`}>
                  <div className="flex items-center gap-4">
                    <div className="relative flex items-center justify-center">
                      <input 
                        type="radio" 
                    ...
                    <Smartphone className="w-[20px] h-[20px] text-[#412A1F]" strokeWidth={1.5} />
                    <span className="text-[14.5px] font-medium text-[#1A1A1A]">Cash on Delivery</span>
                  </div>
                </label>
              </div>
            </div>
      ...
      <div className="lg:hidden flex flex-col gap-6 -mt-4">
        ...
        <div className="flex flex-col gap-4">
          ...
          >
            <CreditCard className={`w-5 h-5 ${paymentMethod === 'card' ? 'text-[#412A1F]' : 'text-[#888888]'}`} />
            <span className="text-[15px] font-bold text-[#1a1a1a]">Credit/Debit Card</span>
          </button>
          ...
          >
            <Smartphone className={`w-5 h-5 ${paymentMethod === 'cod' ? 'text-[#412A1F]' : 'text-[#888888]'}`} />
            <span className="text-[15px] font-bold text-[#1a1a1a]">Cash on Delivery</span>
          </button>
          ...
          >
            <Smartphone className={`w-5 h-5 ${paymentMethod === 'bank' ? 'text-[#412A1F]' : 'text-[#888888]'}`} />
            <span className="text-[15px] font-bold text-[#1a1a1a]">Bank Transfer</span>
          </button>
          ...
          {paymentMethod === 'card' && (
            ...
            >
              <div className="flex flex-col gap-2">
                <label className="text-[13px] text-[#888888] font-medium">Card Number</label>
                <Input 
                  placeholder="1234 5678 9012 3456" 
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[13px] text-[#888888] font-medium">Cardholder Name</label>
                <Input 
                  placeholder="John Doe" 
                  className="h-[52px] bg-[#F9FAFB] border-none rounded-[12px] px-4 text-[15px] focus-visible:ring-1 focus-visible:ring-[#C9A76A]" 
                />
              ...
              <div className="flex gap-4">
                <div className="flex-1 flex flex-col gap-2">
                  <label className="text-[13px] text-[#888888] font-medium">Expiry Date</label>
                  <Input 
                    placeholder="MM/YY" 
                    className="h-[52px] bg-[#F9FAFB] border-none rounded-[12px] px-4 text-[15px] focus-visible:ring-1 focus-visible:ring-[#C9A76A]" 
                  />
                ...
                <div className="flex-1 flex flex-col gap-2">
                  <label className="text-[13px] text-[#888888] font-medium">CVV</label>
                  <Input 
                    placeholder="123" 
                    type="password"
                    maxLength={4}
