      ...
      <div className="flex flex-col gap-4 mt-4">
        ...
        <div onClick={handleAddToCart} className="w-full cursor-pointer">
          <PrimaryButton
            ...
            className="w-full! bg-[#412A1F] border-0 hover:bg-[#2C1A11] rounded-2xl h-14 sm:w-full! justify-center! sm:justify-center! relative text-white"
        ...
        <SecondaryButton
          ...
          className="w-full! bg-white text-[#412A1F] border border-[#412A1F]/20 hover:bg-gray-50 rounded-2xl h-14 sm:w-full! text-md font-bold px-6"
        />
      </div>
    </div>
  );
