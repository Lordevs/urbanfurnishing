    ...
    <HeroSection
      ...
      bottomCard={
        <motion.div
          ...
          <div className="px-8 sm:px-16 py-10 sm:py-5 rounded-[24px] sm:rounded-[28px] shadow-lg flex flex-col gap-7 min-w-[320px] sm:min-w-[480px] bg-[#FFF8F0]/70 backdrop-blur-sm border border-[#F0E9DD]">
