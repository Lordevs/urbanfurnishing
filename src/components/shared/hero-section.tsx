...
export function HeroSection({
  ...
  heightClass = "h-[90dvh] sm:h-screen",
  title,
  description,
  buttons,
  bottomCard,
  ...
  return (
    <section className="px-0 sm:px-10 lg:px-16 max-w-8xl mx-auto">
      <div className={`relative w-full ${heightClass} overflow-hidden sm:rounded-[24px] flex flex-col justify-center px-4 sm:px-16 lg:px-24`}>
        {/* Background & Overlay */}
        <Image
          src={imageSrc}
          alt={imageAlt}
