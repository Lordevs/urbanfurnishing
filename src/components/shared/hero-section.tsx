      ...
      <div className="relative w-full h-screen overflow-hidden rounded-[24px] flex flex-col justify-center px-8 sm:px-16 lg:px-24">
        ...
        <div className="relative z-10 max-w-6xl">
          <motion.h1
            ...
            className="text-4xl sm:text-5xl md:text-6xl lg:text-[60px] font-serif font-semibold tracking-tight text-white mb-2 leading-[1.1]">
            {title}
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-base sm:text-lg lg:text-3xl text-white/90 leading-relaxed mb-10 lg:max-w-4xl font-light">
            {description}
          </motion.p>
